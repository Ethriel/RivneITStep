...
const ContactList = ({ dataContacts, setFavourite, searchOnChange, search, groups, ...props }) => {
    ...
    contacts = contacts.map((contact) => {
        return <ContactItem key={contact.id} contact={contact} groups={groups} setFavourite={setFavourite}></ContactItem>;
    });
